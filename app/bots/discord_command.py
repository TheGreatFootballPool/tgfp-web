...
class GameCommand:
    ...
    async def get_embed(
        self, tgfp_nfl_game_id: str
    ) -> Tuple[discord.Embed, discord.File]:
        """Returns the discord 'embed' for the game"""
        game: Game = await Game.find_one(
            Game.tgfp_nfl_game_id == tgfp_nfl_game_id, fetch_links=True
        )
        ...
        description_header: str = (
            "Below is some data to help you make a decision.\n  "
        ...
        embed = discord.Embed(
            title=espn_game.extra_info["description"],
